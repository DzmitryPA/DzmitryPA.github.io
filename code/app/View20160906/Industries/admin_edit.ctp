            ...
            <?php echo $this->Form->create(Null, array('id' => 'adminForm')); ?>
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Industry Name <span class="require">*</span></label>
                      <div class="col-sm-10">
                    ...
                    <div class="box-footer">
                        ...
                        <?php echo $this->Html->link('Cancel', array('controller'=>'industries', 'action'=>'index','page'=>$this->passedArgs["page"]), array('escape'=>false, 'class'=>'btn btn-default canlcel_le'));?>
                    </div>
                  </div>
                </div>
