<aside class="main-sidebar">
    <section class="sidebar">
        <ul class="sidebar-menu">
            ...
            <li class="treeview <?php if(isset($userListAct) || isset($userAdd)) { echo 'active'; } ?>">
                <a href="javascript:void(0);">
                    <i class="fa fa-building"></i> <span>Manage Companies</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                    <li class="<?php if(isset($userListAct)) { echo 'active'; } ?>"><?php echo $this->Html->link('<i class="fa fa-circle-o"></i> Companies List', array('controller'=>'users', 'action'=>'index'), array('escape'=>false));?></li>
            ...
            <li class="treeview <?php if(isset($catListAct) || isset($catAdd)) { echo 'active'; } ?>">
                <a href="javascript:void(0);">
            ...
            <li class="treeview <?php if(isset($productListAct) || isset($productAdd)) { echo 'active'; } ?>">
                <a href="javascript:void(0);">
                    <i class="fa fa-folder-open"></i> <span>Manage Products</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                    <li class="<?php if(isset($productListAct)) { echo 'active'; } ?>"><?php echo $this->Html->link('<i class="fa fa-circle-o"></i> Products List', array('controller'=>'products', 'action'=>'index'), array('escape'=>false));?></li>
                    <li class="<?php if(isset($productAdd)) { echo 'active'; } ?>"><?php echo $this->Html->link('<i class="fa fa-circle-o"></i> Add Product', array('controller'=>'products', 'action'=>'add'), array('escape'=>false));?></li>
                </ul>
            </li>
            
            <li class="treeview <?php if(isset($serviceListAct) || isset($serviceAdd)) { echo 'active'; } ?>">
                <a href="javascript:void(0);">
                    <i class="fa fa-list"></i> <span>Manage Services</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                    <li class="<?php if(isset($serviceListAct)) { echo 'active'; } ?>"><?php echo $this->Html->link('<i class="fa fa-circle-o"></i> Services List', array('controller'=>'services', 'action'=>'index'), array('escape'=>false));?></li>
                    <li class="<?php if(isset($serviceAdd)) { echo 'active'; } ?>"><?php echo $this->Html->link('<i class="fa fa-circle-o"></i> Add Service', array('controller'=>'services', 'action'=>'add'), array('escape'=>false));?></li>
                </ul>
            </li>
            
            
           <li class="treeview <?php if(isset($stateListAct) || isset($stateAdd)) { echo 'active'; } ?>">
                <a href="javascript:void(0);">
                    <i class="fa fa-table"></i> <span>Manage States</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                    <li class="<?php if(isset($stateListAct)) { echo 'active'; } ?>"><?php echo $this->Html->link('<i class="fa fa-circle-o"></i> States List', array('controller'=>'states', 'action'=>'index'), array('escape'=>false));?></li>
                    <li class="<?php if(isset($stateAdd)) { echo 'active'; } ?>"><?php echo $this->Html->link('<i class="fa fa-circle-o"></i> Add State', array('controller'=>'states', 'action'=>'add'), array('escape'=>false));?></li>
                </ul>
            </li> 
