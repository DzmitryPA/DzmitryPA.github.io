            ...
            <table class="table table-bordered table-striped table-condensed cf">
                <thead class="cf ajshort">
                    <tr>
                        ...
                        <th class="sorting_paging"><?php echo $this->Paginator->sort('Category.type', 'Category Type'); ?></th>
               ...
               <tbody>
                    ...
                    foreach ($categories as $category) {
                        ...
                        <tr>
                            ...
                            <td data-title="Category Name"><?php echo $category['Category']['name']; ?></td>
                            <td data-title="Category Type"><?php echo $catType[$category['Category']['type']]; ?></td>
        ...
        <div class="search_frm">
           <div id="actdiv" class="outside">
            ...
            <?php
                ...
                if (isset($type) && $type != '') {
                    echo $this->Form->hidden('Category.type', array('type' => 'hidden', 'value' => $type));
                }
             ?>
        </div>
