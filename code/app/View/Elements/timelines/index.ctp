            ...
            <div class="timeline_sections_right">
                <div class="timeline_sections_right_top">
                    ...
                    <div class="timeline_sections_right_top_content">
                        ...
                        <?php } ?>
                        <p id="timeline_desc_full<?php echo $timeline['Timeline']['id'] ?>" style="display: none"><?php echo $timeline['Timeline']['description'] ?>  </p>
                        <p id="timeline_desc_less<?php echo $timeline['Timeline']['id'] ?>">
                            <?php if ($timeline['Timeline']['description'] != "") { ?>
                                    ...
                                    if (strlen($string) > 400) {
                                        ...
                                        $string = substr($stringCut, 0, strrpos($stringCut, ' ')) . '...' . $this->Html->link('Show More', 'javascript:void(0);', array('escape' => false, 'onclick' => 'showMore('.$timeline['Timeline']['id'].')'));
                                    }
                                    echo $string;
                                    ?>
                                    <?php }
                    ...
                    <div class="popup_insude_box_ins">
                        ...
                        <div class="popup_insude_box_ins_nofull">
                            ...
                            <div class="popup_fomr_row">
                                ...
                                <div class="input_sor_boc">
                                    <?php echo $this->Form->text('Offer.price', array('class' => 'popup_formtce required number', 'id' => 'offer_price' . $timeline['Timeline']['id'], 'placeholder' => '', 'min' => '0', 'max' => $timeline['Timeline']['asking_price'])); ?>
                                </div>
                            </div>
                            ...
                            <div class="popup_fomr_row">
                                ...
                                <div class="input_sor_boc">
                                    <?php echo $this->Form->text('Offer.quantity', array('class' => 'popup_formtce required digit', 'id' => 'offer_quantity' . $timeline['Timeline']['id'], 'placeholder' => '', 'min' => '1', 'max' => $timeline['Timeline']['quantity'] )); ?>
                                </div>
                            </div>
