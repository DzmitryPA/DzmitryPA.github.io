            ...
            <?php echo $this->Form->create(Null, array('id' => 'adminForm')); ?>
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-5 col-md-4 col-lg-2 control-label">Category Type <span class="require">*</span></label>
                        <div class="col-lg-10 col-sm-7 col-md-8" id="city_list">
                            <?php 
                            global $catType;
                            echo $this->Form->select('Category.type', $catType, array('empty' => 'Category Type', 'class' => "form-control required")); ?>
                        </div>
                    </div>    
                    <div class="form-group">
                    ...
                    <div class="box-footer">
                        ...
                        <?php echo $this->Form->hidden('Category.old_name'); ?>
                        <?php echo $this->Form->submit('Update', array('class' => 'btn btn-info', 'div'=>false)); ?>
                        <?php echo $this->Html->link('Cancel', array('controller'=>'categories', 'action'=>'index','page'=>$this->passedArgs["page"]), array('escape'=>false, 'class'=>'btn btn-default canlcel_le'));?>
                    </div>
                  </div>
                </div>
