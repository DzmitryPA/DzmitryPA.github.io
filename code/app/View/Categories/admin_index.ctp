        ...
        <div class="box box-info">
            ...
            <div class="admin_search">
                <?php echo $this->Form->create(Null, array('id' => 'adminForm')); ?>
                    <div class="form-group align_box dvdrpdd">
                       ...
                       <span class="hint drpdwn_srch"><?php global $catType;
                            echo $this->Form->select('Category.type', $catType, array('empty' => 'Search By Category Type', 'class' => "form-control required")); ?>
                       </span>
