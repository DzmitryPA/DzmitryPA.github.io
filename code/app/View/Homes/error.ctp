<article class="right_part_fulls right_part_fulls_not_found" style="background: #ffffff !important">
    <div class="not_foun_serc">
        <div class="not_foun_serc_cell">
        <div class="im_not_found">
            <img src="<?php echo HTTP_PATH;?>/img/404.png" />
            <div class="clear"></div>
...
<style>
    ...
    .im_not_found{display: table-cell; vertical-align: middle;}
