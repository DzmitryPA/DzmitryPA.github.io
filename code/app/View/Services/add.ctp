    ...
    <div class="aside_contaner_full about_contenteditor about_contenteditor_enewk  radiual_sections">
        ...
        <div class="full_box_of_staf_full">                    
            <div class="left_aprt_of_gst">
                <div class="title_of_page_riweoname revtitle_of_page_riweoname no_bordere">Add Service</div>
            </div>
        </div>
                        ...
                        <div class="cols_two_sksss">
                            ...
                            <div class="popup_fomr_rosdfs_col rightasdas">
                                ...
                                <div class="input_sor_boc">
                                    <?php
                                    global $weight;
                                    echo $this->Form->select('Service.unit_value', $weight, array('empty' => false, 'class' => "popup_formtce slct_ppup required", 'id' => 'SurfaceSelect', 'disabled'));
                                    ?>
                                </div>
                            </div>
...
<div class="cols_two_sksss">
                            <div class="popup_fomr_rosdfs_col">
                                ...
                                <div class="input_sor_boc">
                                    <?php
                                    global $surface;
                                    echo $this->Form->select('Service.unit_value', $surface, array('empty' => false, 'class' => "popup_formtce slct_ppup required", 'id' => 'WeightSelect', 'disabled'));
                                    ?>
                                </div>
                            </div>
