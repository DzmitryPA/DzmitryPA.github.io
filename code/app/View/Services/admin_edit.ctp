        ...
        <div class="box box-info">
            ...
            <div class="form-horizontal">
                <div class="box-body">
                            ...
                            <div class="popup_fomr_rosdfs popup_fomr_rosdfs_left popup_fomr_rosdfs_left_full" id="units_measur" style="display: <?php echo $this->data['Service']['unit_type'] == 0 ? 'none' : 'block' ?>;">
                                <div class="cols_two_sksss">
                                    <div class="popup_fomr_rosdfs_col">
                                        ...
                                        <input type="radio" class="" <?php echo $this->data['Service']['unit_of_measure'] == 'Length' ? 'checked' : '' ?> id="Length" name="data[Service][unit_of_measure]" value="Length">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Delivery Cost <span class="require">*</span></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-sm-7 col-md-8">
                            <div id="ImageID">
                                <?php echo $this->element("admin/services/service_image"); ?>
                            </div>
                    ...
                    <div class="box-footer">
                        ...
                        <?php echo $this->Form->hidden('Service.old_name'); ?>
