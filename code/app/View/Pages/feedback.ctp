...
<script>
    ...
    function ShowLocation(latlng, address, addr_type) {
        ...
        var contentString = '<div class="info_box">' +
                ...
                '<div class="inflseven"><?php echo $contact_details['Admin']['contact']; ?></div>' +
                    ...
                    <div class="con_tu">
                        ...
                        <div class="cont_ac">
                            <div class="con_left">
                                ...
                                <?php
                                if (empty($contact_details['Admin']['company_name']) && empty($contact_details['Admin']['contact']) && empty($contact_details['Admin']['contact_email']) && empty($contact_details['Admin']['address'])) {
                                ...
                                <?php
                                if ($contact_details['Admin']['address'] && $contact_details['Admin']['latitude'] && $contact_details['Admin']['longitude']) {
                                    $stylecss = '';
                                } else {
                                    $stylecss = 'width:100%;';
                                }
                            ...
                            <div class="rig_con">
                                ...
                                <div class="cgtr">
                                    <?php echo $this->Form->create(null, array('method' => 'POST', 'enctype' => 'multipart/form-data', 'name' => 'feedback', 'id' => 'feedback')); ?>
...
<?php echo $this->Form->end(); ?>	
                            ...
                            <div class="clr"></div>
<?php if ($contact_details['Admin']['address'] && $contact_details['Admin']['latitude'] && $contact_details['Admin']['longitude']) { ?>
                                <div class="con_le"> 
                                    <h3 class="fancy-title">
