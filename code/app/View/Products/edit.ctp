    ...
    <div class="aside_contaner_full about_contenteditor about_contenteditor_enewk  radiual_sections">
        ...
        <div class="full_box_of_staf_full">                    
            <div class="left_aprt_of_gst">
                <div class="title_of_page_riweoname revtitle_of_page_riweoname no_bordere">Edit product</div>
            </div>
        </div>
            ...
            <div class="form_edit_full_sboc_xsec" style="border:0; padding: 0;">
                <div class="form_row_fhr">
                    ...
                    <div class="form_row_fhr_cols clear">
                        <?php echo $this->Form->text('Product.price', array('maxlength' => '10', 'class' => "select_input_box required ", 'placeholder' => 'Price', 'min' => '0')); ?>
                    </div>
                    ...
                    <div class="popup_fomr_rosdfs popup_fomr_rosdfs_left popup_fomr_rosdfs_left_full" id="units_measur" style="display: <?php echo $this->data['Product']['unit_type'] == 0 ? 'none' : 'block' ?>;">
                        <div class="cols_two_sksss">
                            <div class="popup_fomr_rosdfs_col">
                                ...
                                <input type="radio" <?php echo $this->data['Product']['unit_of_measure'] == 'Length' ? 'checked' : '' ?> class="" id="Length" name="data[Product][unit_of_measure]" value="Length">
...
<div class="cols_two_sksss">
                    ...
                    <div class="form_row_fhr_cols clear">
                        <?php echo $this->Form->text('Product.minimum_orders', array('maxlength' => '25', 'class' => "select_input_box", 'placeholder' => 'Minimum Order')); ?>
                    </div>
                    ...
                    <div class="form_row_fhr_cols">
                        ...
                        <div id="ImageID">
                            <?php echo $this->element("products/product_image"); ?>
                        </div>
                        ...
                        <div class="shoe_imagrd_rgijt shoe_imagrd_rgijtqwe">
                    ...
                    <div class="form_row_fhr_cols_full form_row_fhr_cols">
                        <?php echo $this->Html->link('Cancel', array('controller' => 'products', 'action' => 'index'), array('escape' => false, 'class' => 'button_form_suber')); ?>
