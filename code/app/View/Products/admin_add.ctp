            ...
            <div class="form-horizontal">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php echo $this->Form->text('Product.price', array('maxlength' => '10', 'class' => "form-control required positiveNumber", 'placeholder' => 'Price ('.CURRENCY.')', 'min' => '0')); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-5 col-md-4 col-lg-2 control-label"> Product Images <span class="require"></span></label>
                        <div class="col-lg-10 col-sm-7 col-md-8">
