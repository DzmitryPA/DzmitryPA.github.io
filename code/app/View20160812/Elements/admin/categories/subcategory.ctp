<?php if ($subcategories) { ?>
    ...
    <div class="panel-body">
        ...
        $urlArray = array_merge(array('controller' => 'categories', 'action' => 'subcategory', $cslug, $separator));
        ...
        <section id="no-more-tables" class="lstng-section">
            <div class="topn">
                <div class="topn_left"><?php echo $catInfo['Category']['name'] ?> Sub Categories List</div>
                    ...
                    foreach ($subcategories as $category) {
                        ...
                        <tr>
                            ...
                            <td data-title="Action">
                                ...
                                <?php echo $this->Html->link('<i class="fa fa-pencil"></i>', array("controller" => "categories", "action" => 'editsubcategory', $category['Category']['slug'], $cslug, 'page'=>$page), array('escape' => false, 'class' => "btn btn-warning btn-xs", 'title' => 'Edit')); ?>
                                <?php echo $this->Html->link('<i class="fa fa-trash-o "></i>', array('controller' => 'categories', 'action' => 'deletesubcategory', $category['Category']['slug'], $cslug, 'page'=>$page), array('update' => 'deleted' . $category['Category']['id'], 'indicator' => 'loaderID', 'class' => 'btn btn-primary btn-xs', 'confirm' => 'Are you sure you want to Delete ?', 'escape' => false, 'title' => 'Delete')); ?>
