                    ...
                    <div class="steps_sections_row stp" id="step2" style="display: none;">
                        ...
                        <div class="col_row_sjde">
                            <span class="select_span_ctot_wwes">
                                ...
                                <?php echo $this->Ajax->observeField('state_id', array('url' => '/states/getCityList/User', 'update' => 'city_list', 'indicator' => 'state_loader')); ?>
                            </span>    
                        </div>
                        <div class="col_row_sjde">
                    ...
                    <div class="steps_sections_row stp" id="step3" style="display: none;">
                        ...
                        <div class="col_row_sjde">
                            <span class="select_span_ctot_wwes">
                                ...
                                <?php echo $this->Ajax->observeField('UserIndustryId', array('url' => '/industries/getSubIndustryList/User', 'update' => 'subind_list', 'indicator' => 'industry_loader')); ?>
                            </span>
                        </div>
                        <div class="col_row_sjde">
