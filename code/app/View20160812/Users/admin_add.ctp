                        ...
                        <div class="steps_sections_row stp" id="step1" style="display: none1;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10 col-sm-7 col-md-8">
                                    <?php echo $this->Form->text('User.company_name', array('class' => "form-control required", 'placeholder' => 'Company Name', 'autocomplete' => 'off', 'onblur' => "checkCompanyName(this.value)")); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10 col-sm-7 col-md-8">
                                    <?php echo $this->Form->text('User.email_address', array('class' => "form-control required email", 'placeholder' => 'Email address', 'autocomplete' => 'off', 'onblur' => "checkEmail(this.value)")); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10 col-sm-7 col-md-8">
                                    <?php echo $this->Form->text('User.unique_id', array('class' => "form-control required", 'placeholder' => 'Unique Id', 'autocomplete' => 'off', 'onblur' => "checkUnique(this.value)")); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10 col-sm-7 col-md-8">
                                    <?php echo $this->Form->password('User.password', array('minlength' => 8, 'class' => "form-control required passold", 'placeholder' => 'Password', 'autocomplete' => 'off')); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10 col-sm-7 col-md-8">
                                    <?php echo $this->Form->password('User.confirm_password', array('class' => "form-control required", 'placeholder' => 'Retype password', 'equalTo' => '#UserPassword')); ?>
                                </div>
                            </div>
                        ...
                        <div class="steps_sections_row stp" id="step3" style="display: none;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10 col-sm-7 col-md-8">
                                    ...
                                    <div class="help_text">Supported File Types: pdf, doc, docx, jpg, jpeg, png (Max. 2MB).</div>
                                </div>
                            </div>
...
<script>
    ...
    function uploadCertificates() {
        ...
        var filetype = ['jpeg', 'png', 'jpg', 'pdf', 'doc', 'docx'];
        if (filename != '') {
