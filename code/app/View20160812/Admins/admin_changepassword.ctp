            ...
            <?php echo $this->Form->create(Null, array('id' => 'adminForm')); ?>
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                          <?php echo $this->Form->password('Admin.old_password', array('class' => "form-control required", 'placeholder' => 'Current Password')); ?>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">New Password <span class="require">*</span></label>
                      <div class="col-sm-10">
                          <?php echo $this->Form->password('Admin.password', array('minlength'=>8,  'class' => "form-control required", 'placeholder' => 'New Password')); ?>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Confirm Password <span class="require">*</span></label>
                      <div class="col-sm-10">
                          <?php echo $this->Form->password('Admin.confirm_password', array( 'class' => "form-control required",'placeholder' => 'Confirm Password', 'equalTo'=>'#AdminPassword')); ?>
                      </div>
                    </div>
