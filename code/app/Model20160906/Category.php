...
class Category extends AppModel {
    ...
    public function getList(){
        $list = $this->find('list', array('conditions'=>array('Category.status'=>1), 'fields'=>array('Category.id', 'Category.name'), 'order'=>array('Category.name ASC')));
        return $list;
    }
    
    public function getSubIndustryList($catId){
