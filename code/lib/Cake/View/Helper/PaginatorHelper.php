 ...
 */
	public function last($last = 'last >>', $options = array()) {
        ...
        function check_sort($sort_field=null,$paginator=null,$direction=null){
		if($paginator == $sort_field){
		    	if($direction == 'asc'){
		    		return $this->Html->image('sort_up.gif',array('border'=>0,'width'=>10,'height'=>10));
		    	}else{
                            return $this->Html->image('sort_down.gif',array('border'=>0,'width'=>10,'height'=>10));
                        }
	        }else{
	        	return false;
	        }
